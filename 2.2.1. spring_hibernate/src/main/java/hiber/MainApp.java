...
//      userService.add(new User("User4", "Lastname4", "user4@mail.ru"));
        ...
        userService.add(new User("User1", "Lastname1", "user1@mail.ru", new Car("111", 111)));
        userService.add(new User("User2", "Lastname2", "user2@mail.ru", new Car()));
        userService.add(new User("User3", "Lastname3", "user3@mail.ru", new Car("333", 333)));
        ...
        List<User> users2 = userService.findUserByCar("333", 333);
        for (User user : users2) {
            System.out.println("Юзер с машиной серии - 333, модели 333");
            System.out.println("Id = " + user.getId());
            System.out.println("First Name = " + user.getFirstName());
            System.out.println("Last Name = " + user.getLastName());
            System.out.println();
